...
export default function Page(){\n  const [open,setOpen]=useState(false);
  ...
  return <AppShell title="Usuários" description="Controle de acesso e perfis"><div className="page-actions"><button className="btn" onClick={()=>setOpen(true)}>+ Novo usuário</button></div><Modal open={open} title="Novo usuário" onClose={()=>setOpen(false)}>
